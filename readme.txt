...
1. What is "Show the link(s) on & after" field for?

This is the date when the link(s) appear on your post/page

== Installation ==

1. Activate the plugin
2. Set the date within post page when the link(s) should appear
